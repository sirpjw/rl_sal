...
public:
    ...
    void Enter() override
    {
        ...
        try
        {
            ...
            while (rl.output_dof_pos_queue.try_pop(discard)) {}
            while (rl.output_dof_vel_queue.try_pop(discard)) {}
            while (rl.output_dof_tau_queue.try_pop(discard)) {}
        }
